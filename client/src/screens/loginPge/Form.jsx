...
//yup validation schemas determines the shape of how the form library is going to be saving this information
//i.e if you ut a number it stops you or if you do not input anything
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    // form data allows sending of formdata with images
